...
public class OrderRepeatedOrderTest{
    public static void main(String[] args) {
        ...
        DateOrder temp = new DateOrder(10,13,2007);
        ...
        DateOrder temp1 = new DateOrder(10,13,2020);
        ...
        DateOrder temp2 = o2.getOrderDate();
        ...
        DateOrder t = new DateOrder(3,21,2017);
        DateOrder t1= new DateOrder(10,21,2017);
        RepeatedOrder r1 = new RepeatedOrder("HAL Industries","A2",t,10,10,t1);
        boolean ar1=r1.toString().equals("O=6 C=HAL Industries P=A2 D=3/21/2017 A=10 Period=10 E=10/21/2017");
        ...
        boolean ar2=r2.toString().equals("O=7 C=HAL Industries P=A2 D=3/21/2017 A=10 Period=0 E=10/21/2017");
        ...
        RepeatedOrder r3 = new RepeatedOrder("HAL Industries","A2",t,10,10,null);
        boolean ar3=r3.toString().equals("O=8 C=HAL Industries P=A2 D=3/21/2017 A=10 Period=10 E=3/21/2017");
        ...
        DateOrder t2 = new DateOrder(5,15,2020);
        r1.setEndDate(t2);
        t2.setDate(11, 13, 2020);
        boolean ar4=r1.toString().equals("O=6 C=HAL Industries P=A2 D=3/21/2017 A=10 Period=10 E=5/15/2020");
        if (ar4) System.out.println("PASSED");
        else System.out.println("FAILED "+ r1);

        //check getEndDate does deep copy
        System.out.print("check getEndDate(does deep copy testing ");
        DateOrder t3 = r2.getOrderDate();
        t3.setDate(1, 1, 2020);
        boolean ar5=r2.toString().equals("O=7 C=HAL Industries P=A2 D=3/21/2017 A=10 Period=0 E=10/21/2017");
