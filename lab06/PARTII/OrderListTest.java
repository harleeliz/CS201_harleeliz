...
public class OrderListTest {
    ...
    public static void main(String[] args) {
        ...
        RepeatedOrderThree r1 = new RepeatedOrderThree("Orange Inc.","C2",temp1,7,30,temp2);
        Date temp3 = new Date(1,24,2004);
        Date temp4 = new Date(2,5,2004);
        RepeatedOrderThree r2 = new RepeatedOrderThree("Orange Inc.","C2",temp3,1,30,temp4);
        Date temp5 = new Date(10,10,2002);
        Date temp6 = new Date(10,30,2002);
        RepeatedOrderThree r3 = new RepeatedOrderThree("Orange Inc.","A1",temp5,8,30,temp6);
        Date temp7= new Date(10,13,2007);
        OrderThree o1 = new OrderThree("HAL Industries","A2",temp7,10);
        Date temp8= new Date(3,23,2003);
        OrderThree o2 = new OrderThree("HAL Industries","A1",temp8,8);
        Date temp9= new Date(3,16,2007);
        OrderThree o3 = new OrderThree("Orange Inc.","C3",temp9,8);
        Date temp10= new Date(5,17,2006);
        OrderThree o4 = new OrderThree("HAL Industries","C3",temp10,1);
        list.addOrder(r1);
        list.addOrder(r2);
        list.addOrder(r3);
        list.addOrder(o1);
        ...
        RepeatedOrderThree r11 = new RepeatedOrderThree("Orange Inc.","C2",temp11,7,30,temp12);
        Date temp17= new Date(10,13,2007);
        OrderThree o11 = new OrderThree("HAL Industries","A2",temp17,10);
        list1.addOrder(r11);
        list1.addOrder(o11);
